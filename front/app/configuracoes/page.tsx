...
const sections = [
  { href: "/atencao", title: "Aviso de atenção", description: "Configure e reproduza o aviso sonoro da recepção.", icon: BellRing, color: "bg-amber-500" },
  { href: "/configuracao", title: "Voz e áudio", description: "Escolha vozes, velocidade, volume e regras automáticas.", icon: SlidersHorizontal, color: "bg-violet-600" },
  { href: "/dic", title: "Dicionário", description: "Ajuste a pronúncia de nomes e termos usados nas chamadas.", icon: BookOpenText, color: "bg-emerald-600" },
  { href: "/guiche", title: "Guichês", description: "Cadastre e organize os pontos de atendimento.", icon: UsersRound, color: "bg-cyan-600" },
  { href: "/recepcao", title: "Recepções", description: "Associe modalidades às recepções e localizações.", icon: MapPin, color: "bg-rose-600" },
  { href: "/setup-painel", title: "Painéis", description: "Distribua serviços e modalidades entre os painéis.", icon: MonitorCog, color: "bg-blue-600" },
  { href: "/status", title: "Status e consumo", description: "Acompanhe a voz ativa, uso diário e histórico.", icon: Gauge, color: "bg-slate-700" },
  { href: "/logs", title: "Logs do sistema", description: "Consulte a jornada do totem e ações administrativas.", icon: ScrollText, color: "bg-orange-600" },
  { href: "/usuarios", title: "Usuários", description: "Cadastre e gerencie o acesso administrativo.", icon: UserCog, color: "bg-indigo-600" },
];
